    ...
    <>
      ...
      >
        <div className="space-y-6">
              ...
              {[
                ...
                <div
                  ...
                  className={`flex flex-col items-center px-3 ${
                    idx < arr.length - 1 ? "border-r border-gray-900" : ""
                  }`}
                >
          ...
          <div>
            <h2 className="font-semibold text-xl mb-2 font-jakarta">
              Kepemilikan
            </h2>
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-4 p-4 bg-white rounded-lg">
            <div className="font-jakarta text-sm text-gray-700 min-w-0">
              <p>
                Anda berminat untuk mengambil rumah ini?{" "}
          ...
          <button className="w-full md:w-auto py-2 px-10 rounded-xl bg-green-500 hover:bg-green-600 transition flex items-center justify-center gap-2 whitespace-nowrap">
            Edit Detail
          </button>
        </div>
        ...
        <div className="flex flex-col items-center">
          <div className="relative w-full">
            <img
              src={`${API.endpointImage}/${imageShow}?v=${
                Math.random() * 2000
              }`}
              alt="fotorumah"
