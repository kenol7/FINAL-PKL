...
import imageContoh1 from "../../assets/rumah/rumah1.jpg";
import imagecontoh2 from "../../assets/rumah/rumah2.jpg";
import imagecontoh3 from "../../assets/rumah/rumah3.jpg";
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                            <div className="font-jakarta">
                                <h1 className="text-xl md:text-2xl font-bold">{item.cluster_apart_name}</h1>
                                <h3 className="text-sm text-gray-600">{item.city}</h3>
                            </div>
                            <div className="bg-[#E7C555] rounded-2xl w-full md:w-[244px] h-[45px] flex items-center justify-center text-center text-lg font-semibold">
                                Rp{" "}
                                {item.property_price
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-4 p-3 bg-gray-50 rounded-lg">
                            <div className="flex flex-wrap gap-4 text-sm font-jakarta justify-center md:justify-start">
                                {[
                                    { label: "L.Tanah", value: `${item.square_land}m²` },
                                    { label: "L.Bangunan", value: `${item.square_building}m²` },
                                    { label: "Lantai", value: item.property_floor },
                        ...
                        <div>
                            <h2 className="font-semibold text-xl mb-2">Kepemilikan</h2>
                            <p className="text-sm">
                                Dhika <br />
                                Menengah grade 2 <br />
                                Matang - Nonresidensial <br />
                                Residensial <br />
                                SHM
                            </p>
                        </div>
